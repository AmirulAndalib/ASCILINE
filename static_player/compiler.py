...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ASCILINE Static Compiler (V2)")
    ...
    parser.add_argument("--tolerance", type=int, default=0, help="Color drift tolerance for delta compression (0 = lossless)")
